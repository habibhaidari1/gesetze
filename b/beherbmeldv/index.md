---
Title: Verordnung über die elektronische Speicherung von Daten zur Einhaltung der besonderen Meldepflicht in Beherbergungsstätten
jurabk: BeherbMeldV
layout: default
...
ausländischen Personen in Beherbergungsstätten nach § 29 Absatz
5 und § 30 Absatz 4 des Bundesmeldegesetzes durch die Leiter der
...
(2) Die Daten sind als strukturierter maschinenlesbarer Datensatz
im Dateiformat der Extensible Markup Language (XML) zu speichern.
Die Daten sind im UNICODE-Zeichensatz UTF 8 zu codieren. Das
...
„JJJJMMTT_BeherbMeldeschein_Zaehler.xml“ zu benennen. Dabei ist
einzusetzen:
...
| 7. | Anschrift | bestehend aus  a) Staat, in dem sich der Wohnort befindet b) Postleitzahl des Wohnorts c) Wohnortbezeichnung d) sofern vorhanden, Zusätze zum Wohnort e) Straßenbezeichnung f) Hausnummerziffern sowie gegebenenfalls zusätzlich Buchstaben oder Zusatzziffern g) sofern vorhanden, Ergänzungen zur Anschrift |
