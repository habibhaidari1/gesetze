...
1.  einen Betrieb im Holzblasinstrumentenmacher-Handwerk führen
...
7.  Leistungen im Holzblasinstrumentenmacher-Handwerk erbringen,
    ...
    e)  Spezialwerkzeuge für die Herstellung und Bearbeitung von
        Holzblasinstrumenten, insbesondere Kopiervorrichtungen, Werkzeuge
        zur Bearbeitung der Innenbohrung, Biegevorrichtungen und Schablonen
        herstellen,
...
8.  technische, organisatorische und rechtliche Gesichtspunkte bei der
    ...
    h)  die Handhabung, die Lagerung, die Verarbeitung und die Entsorgung
        von Gefahrgütern,
...
1.  ein Holzblasinstrument einschließlich der Kostenkalkulation zu
    planen, herzustellen, anzuspielen, auszustimmen und die Ergebnisse zu
    dokumentieren oder

2.  für ein bestehendes Holzblasinstrument eine benutzerbezogene
    Anpassung oder Reparatur, die sowohl den Korpus mit seinen akustischen
    Eigenschaften als auch die Mechanik umfasst, zu planen, die
    dafür benötigten Teile herzustellen und in das Holzblasinstrument
...
Anpassung oder Reparatur notwendigen Informationen, einer Stück-
und Materialliste sowie der Kostenkalkulation. Auf dieser Grundlage
sind im Rahmen der Durchführung Korpusbauteile, Bauteile der
Klappenmechanik und Tonlöcher herzustellen, Oberflächen zu behandeln,
Bauteile zu fügen und als spielfertiges Instrument zusammenzubauen.
Im Falle eines Instruments nach Absatz 2 Satz 2 Nummer 5 oder 6
ist jeweils das Kopfstück herzustellen. Der Prüfungsausschuss legt
fest, welche Teile des Korpusses und der Klappenmechanik als selbst
...
Stunden zur Verfügung. Jede Arbeit nach Absatz 2 Satz 2 Nummer 1 bis
3 wird gesondert bewertet. Die Bewertungen der einzelnen ausgeführten
...
Ergebnis mit der Bewertung der Situationsaufgabe im Verhältnis 2 :
1 gewichtet.
...
nachzuweisen, dass er die besonderen fachtheoretischen Kenntnisse im
...
erfolgs-, kunden- und qualitätsorientiert, auch unter Anwendung
von Informations- und Kommunikationstechnologien, zu analysieren,
Lösungen zu planen und anzubieten. Dabei hat er musikalische,
akustische, materialspezifische, verwendungszweckbezogene und
sonstige kundenwunschbezogene, ökologische, ökonomische und soziale
...
1.  Kundenwünsche und die Rahmenbedingungen zu deren Erfüllung
    ...
    a)  Vorgehensweise zur strukturierten Ermittlung der Kundenwünsche und
        ...
        im Hinblick auf musikalische, akustische, haptische, optische und
...
2.  Lösungsmöglichkeiten entwickeln, erläutern und begründen, auch
    ...
    c)  Eigenschaften und Zustand von Materialien, insbesondere auch in
        ...
        natürliche Alterung und Umwelteinflüsse*,* bewerten,
...
erfolgs-, kunden- und qualitätsorientiert, auch unter Anwendung
von Informations- und Kommunikationstechnologien, zu erbringen, zu
...
2.  die Leistungen erbringen, hierzu zählen insbesondere:
    ...
    f)  Vorgehensweise zur Entlackung, zur Entfernung galvanischer
...
Handwerk unter Berücksichtigung der Rechtsvorschriften, auch
...
4.  Personal unter Berücksichtigung gewerbespezifischer Bedingungen planen
    ...
    e)  Maßnahmen zur fortlaufenden Qualifizierung, insbesondere
        unter Berücksichtigung des Berufslaufbahnkonzepts im
...
Holzblasinstrumentenmachermeisterverordnung vom 7. Oktober 1997
(BGBl. I S. 2455), die durch Artikel 2 Absatz 26 der Verordnung vom
