...
über dieses Guthaben mittels Schecks zu verfügen. Die Gültigkeit
der Urkunde als Scheck wird jedoch durch die Nichtbeachtung dieser
...
(3) Der Scheck kann nicht auf den Aussteller selbst gezogen werden,
es sei denn, daß es sich um einen Scheck handelt, der von einer
...
um gültig zu sein, auf die Rückseite des Schecks oder auf den Anhang
gesetzt werden.
...
(2) Er kann untersagen, daß der Scheck weiter indossiert wird;
in diesem Falle haftet er denen nicht, an die der Scheck weiter
indossiert wird.


### Art 19

Wer einen durch Indossament übertragbaren Scheck in Händen hat,
gilt als rechtmäßiger Inhaber, sofern er sein Recht durch eine
...
Scheck geltend machen; aber er kann ihn nur durch ein weiteres
...
weder mit dem Tode noch mit dem Eintritt der Handlungsunfähigkeit
des Vollmachtgebers.


### Art 24

(1) Ein Indossament, das nach Erhebung des Protests oder nach
Vornahme einer gleichbedeutenden Feststellung oder nach Ablauf der
...
datiertes Indossament vor Erhebung des Protests oder vor der
...
(2) Ist die Vorlegung am letzten Tage der Frist erfolgt, so kann
der Protest oder die gleichbedeutende Feststellung auch noch an dem
...
seinem unmittelbaren Vormanne von der Nachricht, die er erhalten hat,
...
Protest erheben oder eine gleichbedeutende Feststellung vornehmen
zu lassen.
...
einem Scheckbürgen beigefügt, so sind alle Scheckverpflichteten
zum Ersatz der Kosten eines dennoch erhobenen Protests oder einer
...
(1) Jeder Scheckverpflichtete, gegen den Rückgriff genommen wird
oder genommen werden kann, ist berechtigt, zu verlangen, daß ihm
gegen Entrichtung der Rückgriffssumme der Scheck mit dem Protest
oder der gleichbedeutenden Feststellung und eine quittierte Rechnung
ausgehändigt werden.
...
dem Fall der höheren Gewalt unverzüglich zu benachrichtigen und die
...
Vormann von dem Fall der höheren Gewalt benachrichtigt hat, so
...
Lande als dem der Ausstellung oder in einem überseeischen Gebiet
...
Scheckverpflichteten verjähren in sechs Monaten von dem Tage, an
dem der Scheck von dem Verpflichteten eingelöst oder ihm gegenüber
...
Bürgerlichen Gesetzbuchs wirken nur gegen den Scheckverpflichteten,
...
(3) Im übrigen finden auf die Vorlegung des Schecks und den
Protest die Vorschriften der Artikel 79 bis 87 des Wechselgesetzes
...
(1) Ein abhanden gekommener oder vernichteter Scheck kann im
Wege des Aufgebotsverfahrens für kraftlos erklärt werden. Die
Aufgebotsfrist muß mindestens zwei Monate betragen. Nach Einleitung
des Aufgebotsverfahrens kann der Berechtigte, falls der Scheck
rechtzeitig zur Zahlung vorgelegt, von dem Bezogenen aber nicht
eingelöst worden war, von dem Aussteller Zahlung fordern, wenn er bis
zur Kraftloserklärung Sicherheit leistet.
...
beglaubigte Abschrift der Urkunde verwahrenden Stelle zu erteilen
ist. In dem Zeugnis muß der Inhalt des Protests und des gemäß Artikel
55 Abs. 3 in Verbindung mit Artikel 85 Abs. 2 des Wechselgesetzes
...
(2) Ist nach diesem Recht der Scheck im Hinblick auf die Person
des Bezogenen nichtig, so sind gleichwohl die Verpflichtungen aus
